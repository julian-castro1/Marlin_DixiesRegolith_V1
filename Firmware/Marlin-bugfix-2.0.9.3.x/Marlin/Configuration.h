...
#define STRING_CONFIG_H_AUTHOR "(LUNAR RESOURCES, Julian Castro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Dixie's Regolith Printer"
...
#define X_BED_SIZE 152  // 6in
#define Y_BED_SIZE 152  // 6in
